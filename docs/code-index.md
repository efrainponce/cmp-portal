...
- [src/boards/proyectos/ProyectoBoard.tsx](src/boards/proyectos/ProyectoBoard.tsx) — Orquestador de Proyectos (post-venta) + botón "Nuevo proyecto" en los accesos Documentación y Tallas / Órdenes de Compra (los que muestran la etapa en la que nace). Exports: ProyectoBoard.
