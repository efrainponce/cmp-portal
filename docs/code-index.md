...
- [worker/lib/itemOculto.ts](worker/lib/itemOculto.ts) — "Quitar" un item del portal SIN borrarlo de Monday (el portal nunca borra allá). El estado vive en su propia tabla para que refetch/reconcile no resuciten la línea. Exports: ensureItemOcultoTable, NOT_OCULTO, ocultarItem, restaurarItem, estaOculto.
