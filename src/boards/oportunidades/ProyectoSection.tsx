...
// tuvo que cambiar.
export { P_SHEET_LINK, P_OC_CLIENTE, P_OC_CLIENTE_LEGADO, P_ACTA_ENTREGA, ESTADO_PRODUCTO_COLORS, useProyecto, linkUrl, type ProyectoState } from './proyecto/shared';
