...
/** Asienta lo que se leyó del PDF de la orden (src/lib/ocPdfMonto.ts): fecha y
 * totales, cualquiera puede faltar. */
export async function setOcPdfDatos(folio: string, d: {
